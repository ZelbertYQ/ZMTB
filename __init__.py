bl_info = {
    ...
    "description": "A collection of tools for vertex colors, weight painting, vertex groups, and shape keys.",
    "category": "中文版",
}
...
from .uv_snapshot import uv_snapshot  # 新增导入
...
class SK_TOOLS_PT_main_panel(Panel):
    ...
    def draw(self, context):
        ...
        # SK Keeper Section
        box = layout.box()
        box.label(text="保留形态键", icon='SHAPEKEY_DATA')
